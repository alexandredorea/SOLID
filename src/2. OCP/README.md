...
Este é o segundo princípio do SOLID e certamente o princípio mais polêmico, desconhecido e não utilizado. Descrito por [Bertrand Meyer] (1988), diz basicamente o seguinte:
...
Para o uso do Open Closed Principle é muito comum utilizarmos o [Strategy Pattern]() descrito nos [Padrões de Projetos da Gangue dos Quatro (Gang of Four - GoF)][GOF], prometo explicá-lo em outro momento, apenas para não tornar este exemplo muito complexo.
